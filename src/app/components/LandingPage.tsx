          ...
          <div className="grid md:grid-cols-3 gap-4 md:gap-5 max-w-5xl mx-auto mb-10">
            {copy.pricing.packs.map((pack) => {
              ...
              return (
                <div
                  key={pack.sessions}
                  className={`relative rounded-2xl p-5 md:p-6 flex flex-col transition-shadow ${
                    isFeatured
                ...
                >
                  {/* Badge */}
                  {pack.discount && (
                    <div className={`absolute -top-2.5 right-4 px-2.5 py-1 rounded-full text-[10px] ${
                      isFeatured
                  ...
                  {/* CTA */}
                  <button
                    className={`w-full py-2.5 rounded-full text-sm mb-5 transition-colors ${
                      isFeatured
