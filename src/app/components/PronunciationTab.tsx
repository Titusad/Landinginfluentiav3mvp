    ...
    return (
      <div className="mt-3 space-y-2.5">
        ...
        <button
          ...
          className={`w-full py-2.5 rounded-xl flex items-center justify-center gap-2 transition-all shadow-sm cursor-pointer ${
            isPlaying
        ...
        <button
          ...
          className={`w-full py-2.5 rounded-xl flex items-center justify-center gap-2 transition-all cursor-pointer ${
            hasListened
